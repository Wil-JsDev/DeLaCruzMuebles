...
INSERT INTO FACTURA(ID_FACTURA,TIPO_DE_PAGO,ID_CLIENTE,ID_EMPLEADO,FECHA)
VALUES(@IdFactura,@Tipo_De_Pago,@Id_Cliente,@Id_Empleado,@Fecha);
...
EXEC InsertarProductoEnInventario
    @IdCategoria = 1,
    @Cantidad = 10,
    @IdProducto = 2;


ALTER PROCEDURE LeerInventario
AS 
BEGIN
SELECT * FROM PRODUCTO
END
...
--Inverntario
ALTER PROCEDURE InsertarProductoEnInventario
(
@IdCategoria INT,
@Cantidad INT,
@IdProducto INT
...
BEGIN
	...
	UPDATE PRODUCTO
        ...
        WHERE ID_PRODUCTO = @IdProducto AND ID_CATEGORIA = @IdCategoria;
END
